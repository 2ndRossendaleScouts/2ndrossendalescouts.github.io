...
export function SectionPage({ section }: { section: SectionKey }) {
  ...
  return <>
    <section className="page-hero"><div className="wrap"><span className="pill">{data.age}</span><p className="eyebrow">2nd Rossendale {data.title}</p><h1>{data.title}</h1><p className="lead">{data.lead}</p><div className="actions"><a className="btn primary" href="contact.html">Enquire about joining</a></div></div></section>
